...
public class CodeGenerator {
	...
	final static private String PACKAGE = "com.minierp";
	final static private String REQUESTPATH = "stock";
	final static private String HTMLPATH = "stock";
	...
	private String getHtmlPath(Class<?> domainClass) {
		return "src\\main\\webapp\\" + HTMLPATH + "\\" + domainClass.getSimpleName().toLowerCase() + "_manager.html";
	}
}